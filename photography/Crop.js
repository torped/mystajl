...
import {withStyles, type StyleProps, type StylesProps, type StyleSheet, type Theme} from "../theme";
        ...
        return (
            <View style={style}>
                ...
                <View ref={this.setCrop} style={RNStyleSheet.absoluteFill}>
                    ...
                    <View ref={'topLeft'} style={styles.topLeftResponder} {...this.topLeftResponder.panHandlers}>
                        <View style={styles.topLeft} />
                    </View>
                    <View ref={'topRight'} style={styles.topRightResponder} {...this.topRightResponder.panHandlers}>
                        <View style={styles.topRight} />
                    </View>
                    <View ref={'bottomLeft'} style={styles.bottomLeftResponder} {...this.bottomLeftResponder.panHandlers}>
                        <View style={styles.bottomLeft} />
                    </View>
                    <View ref={'bottomRight'} style={styles.bottomRightResponder} {...this.bottomRightResponder.panHandlers}>
