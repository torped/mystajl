...
import {Image, StyleGuide, type NavigationProps} from "../index";
...
export default class PhotoThumbnail extends React.PureComponent<PhotoProps> {
    ...
    onPress = () => {
        ...
        //console.log('hej',photo, from);
        //navigation.navigate("PhotoEdit", { photo: photo, from: 'from' });
        this.props.navigation.navigate('PhotoEdit', {photo:  photo, from: 'Tenhult'})
    }
